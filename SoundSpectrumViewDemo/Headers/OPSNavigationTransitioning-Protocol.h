...
@protocol OPSNavigationTransitioning <NSObject>

@optional
- (void)customHideInteractiveTransitionWithPanTranslation:(struct CGPoint)arg1 toViewController:(UIViewController *)arg2;
...
- (UIViewController *)viewControllerToPushWithDirection:(long long)arg1;
