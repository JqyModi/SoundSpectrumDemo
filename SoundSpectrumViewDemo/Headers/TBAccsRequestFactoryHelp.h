...
+ (id)getRequestDataWithTargetData:(id)arg1 sourceData:(id)arg2 dataFlag:(unsigned short)arg3 dataId:(id)arg4 sendData:(id)arg5 extHeaderData:(id)arg6 error:(long long *)arg7;
+ (id)getRequestDataWithTargetData:(id)arg1 sourceData:(id)arg2 dataFlag:(unsigned short)arg3 dataId:(id)arg4 sendData:(id)arg5 extHeader:(id)arg6 error:(long long *)arg7;
