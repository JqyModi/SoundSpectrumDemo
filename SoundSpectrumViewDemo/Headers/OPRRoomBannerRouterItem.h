...
@interface OPRRoomBannerRouterItem : NSObject <OPSRouterItemProtocol, OPSRouterRegisterProtocol>
{
}

+ (id)routerPath;
+ (id)routerHost;
+ (id)url:(id)arg1 appendRouterWithId:(id)arg2;
+ (void)routeWithId:(id)arg1;
+ (void)registerRouter;
