...
@interface OPRJsHandlerCommon : NSObject <OPRJsHandlerProtocol>
{
    id <OPRJsHandlerPushMessageProtocol> _pushDelegate;
}

+ (id)accountApiCmsWhiteList;
+ (id)apiHardcodeWhiteList;
+ (id)apiWhiteList;
@property(nonatomic) __weak id <OPRJsHandlerPushMessageProtocol> pushDelegate; // @synthesize pushDelegate=_pushDelegate;
- (void).cxx_destruct;
- (_Bool)canRequest:(id)arg1 withType:(long long)arg2;
- (void)processRequest:(id)arg1 responseBlock:(CDUnknownBlockType)arg2 msgId:(id)arg3;
- (void)processAccountDestroySuccess;
- (void)share2:(id)arg1;
- (void)share:(id)arg1;
