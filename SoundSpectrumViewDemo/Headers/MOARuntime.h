...
+ (void)replaceInstanceMethodForClass:(Class)arg1 selector:(SEL)arg2 implementationBlock:(id)arg3;
+ (void)replaceClassMethodForClass:(Class)arg1 selector:(SEL)arg2 implementationBlock:(id)arg3;
