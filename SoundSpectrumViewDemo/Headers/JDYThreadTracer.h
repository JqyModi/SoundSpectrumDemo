...
+ (id)generateTraceReportForThreadScenes:(id)arg1 needSymbolicated:(_Bool)arg2 reason:(id)arg3;
...
+ (id)generateTraceReportForCurrentThread;
...
+ (id)formattedDeviceInfoWithCustomizedReason:(id)arg1;
