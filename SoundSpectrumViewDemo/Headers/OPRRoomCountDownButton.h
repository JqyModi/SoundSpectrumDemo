...
@interface OPRRoomCountDownButton : UIButton <CAAnimationDelegate>
{
    double _timeout;
    double _presentTimeInterval;
    CALayer *_progressLayer;
    CALayer *_animationLayer;
    CALayer *_customBGLayer;
}

@property(retain, nonatomic) CALayer *customBGLayer; // @synthesize customBGLayer=_customBGLayer;
...
- (void)setProgressLayerHidden:(_Bool)arg1;
