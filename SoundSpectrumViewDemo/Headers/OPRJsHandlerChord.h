...
@interface OPRJsHandlerChord : NSObject <OPRJsHandlerProtocol>
{
    id <OPRJsHandlerPushMessageProtocol> _pushDelegate;
    NSDictionary *_chordDataFromWebPage;
}

@property(retain, nonatomic) NSDictionary *chordDataFromWebPage; // @synthesize chordDataFromWebPage=_chordDataFromWebPage;
