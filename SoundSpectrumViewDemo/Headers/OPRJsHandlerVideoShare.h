...
@interface OPRJsHandlerVideoShare : NSObject <OPRJsHandlerProtocol>
{
...
- (void).cxx_destruct;
- (void)shareVideo:(id)arg1 responseBlock:(CDUnknownBlockType)arg2 msgId:(id)arg3;
- (void)genVideo:(id)arg1 responseBlock:(CDUnknownBlockType)arg2 msgId:(id)arg3;
