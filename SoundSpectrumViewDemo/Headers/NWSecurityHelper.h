...
+ (id)sign:(id)arg1;
+ (id)getAuthSign:(id)arg1 withAuthCode:(id)arg2;
+ (id)getAuthSign:(id)arg1 withAppSecret:(id)arg2;
+ (id)getAuthOperator;
...
+ (id)signWithSecurityGuard:(id)arg1 withAppkey:(id)arg2 withAuthCode:(id)arg3;
