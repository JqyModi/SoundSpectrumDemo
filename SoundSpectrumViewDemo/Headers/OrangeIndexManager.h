...
@property __weak OrangeConfigCenter *configCenter; // @synthesize configCenter=_configCenter;
@property(retain) OrangeIndexModel *indexModel; // @synthesize indexModel=_indexModel;
- (void).cxx_destruct;
