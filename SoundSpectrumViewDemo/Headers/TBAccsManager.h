...
#import "NWSessionAuthenticationDelegate-Protocol.h"

@class DataChannel, NSString, TBAccsConfiguration, TBAccsReceiveAndCallBackCenter, TBAccsRequestQueue;

@interface TBAccsManager : NSObject <NWSessionAuthenticationDelegate, AccsProtocol>
{
...
- (void).cxx_destruct;
- (void)nwsessionDidAuthFinishLoading:(id)arg1;
- (void)nwsession:(id)arg1 didAuthReceiveData:(id)arg2;
- (void)nwsession:(id)arg1 didAuthFailWithError:(id)arg2;
- (void)nwsession:(id)arg1 didAuthReceiveResponse:(id)arg2;
- (void)nwsessionWillSendRequestForAuthentication:(id)arg1;
