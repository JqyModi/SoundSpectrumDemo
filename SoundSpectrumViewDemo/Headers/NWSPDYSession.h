...
- (_Bool)is0RTT;
- (_Bool)isAuth;
- (void)setSocketPublickey:(id)arg1 forSocket:(NAL_session_t_b975b184 *)arg2;
- (NAL_session_t_b975b184 *)createTnetSocket:(id)arg1;
- (_Bool)isDisableIPv4Convertion;
- (id)initWithOrigin:(id)arg1 host:(id)arg2 delegate:(id)arg3 policy:(id)arg4 ignLoc:(_Bool)arg5 sessionId:(id)arg6;
