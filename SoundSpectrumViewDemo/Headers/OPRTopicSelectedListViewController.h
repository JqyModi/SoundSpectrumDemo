...
@interface OPRTopicSelectedListViewController : OPRBaseTableViewController
{
    NSArray *_selectedIds;
    CDUnknownBlockType _selectedTopicBlock;
    NSString *_clipId;
    NSArray *_items;
...
@property(copy, nonatomic) CDUnknownBlockType selectedTopicBlock; // @synthesize selectedTopicBlock=_selectedTopicBlock;
@property(retain, nonatomic) NSArray *selectedIds; // @synthesize selectedIds=_selectedIds;
- (void).cxx_destruct;
- (void)statPageToLogserver:(id)arg1;
- (void)closeViewController:(CDUnknownBlockType)arg1;
