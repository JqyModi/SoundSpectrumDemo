...
@interface NWHttpConnection : NWBaseConnection
{
    ...
    double _beginRecvDataTime;
}

+ (id)httpSessionDemux;
@property(nonatomic) _Bool isRetriedByDomain; // @synthesize isRetriedByDomain=_isRetriedByDomain;
@property(nonatomic) double beginRecvDataTime; // @synthesize beginRecvDataTime=_beginRecvDataTime;
...
- (void)dispatch2Proxy;
- (_Bool)isNeedRetryError:(id)arg1;
- (_Bool)filterAtsHttpsDetectingError:(id)arg1;
- (void)dispatch2Forbidden;
- (void)dispatch2Cfnetwork;
- (void)retryWithType:(int)arg1;
- (void)resetURLDomain:(id)arg1;
- (void)utDidReceiveResponse:(id)arg1;
- (void)cancel;
- (void)start;
