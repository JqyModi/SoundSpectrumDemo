...
@class NSMutableArray, NSRecursiveLock, NSString, NWConcurrentMutableSet;
...
@interface NWHTTPDNSTools : NSObject
{
    ...
    NWConcurrentMutableSet *_sentHosts;
    NWConcurrentMutableSet *_respHosts;
    _Bool _isRequestedForAMDC;
    NSString *_netIp;
}

+ (_Bool)filterTestDomain:(id)arg1;
+ (id)sharedInstance;
@property(nonatomic) _Bool isRequestedForAMDC; // @synthesize isRequestedForAMDC=_isRequestedForAMDC;
...
- (_Bool)isHostResponse:(id)arg1;
- (_Bool)isHostRequested:(id)arg1;
- (id)init;
