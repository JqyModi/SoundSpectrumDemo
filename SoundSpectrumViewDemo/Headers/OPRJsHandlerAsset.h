...
@interface OPRJsHandlerAsset : NSObject <OPRJsHandlerProtocol>
{
...
- (void).cxx_destruct;
- (void)downloadVideoAsset:(id)arg1 responseBlock:(CDUnknownBlockType)arg2 msgId:(id)arg3;
- (void)getVideoAssetInfo:(id)arg1 responseBlock:(CDUnknownBlockType)arg2 msgId:(id)arg3;
