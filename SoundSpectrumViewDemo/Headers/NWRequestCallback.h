...
@interface NWRequestCallback : NSObject
{
    ...
    _Bool _callbackOnMain;
    id <NWURLConnectionDelegate> _delegate;
    NWRequestContext *_context;
    NSOperationQueue *_delegateQueue;
    NWCacheResponse *_cacheResponse;
    double _rspRecvEndTime;
    double _cbDispatchTime;
    double _cbStartTime;
    double _cbEndTime;
}

@property(nonatomic) _Bool callbackOnMain; // @synthesize callbackOnMain=_callbackOnMain;
@property(nonatomic) double cbEndTime; // @synthesize cbEndTime=_cbEndTime;
@property(nonatomic) double cbStartTime; // @synthesize cbStartTime=_cbStartTime;
@property(nonatomic) double cbDispatchTime; // @synthesize cbDispatchTime=_cbDispatchTime;
@property(nonatomic) double rspRecvEndTime; // @synthesize rspRecvEndTime=_rspRecvEndTime;
