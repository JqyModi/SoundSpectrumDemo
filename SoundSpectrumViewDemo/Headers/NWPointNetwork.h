...
@interface NWPointNetwork : NWStatisticPoint
{
    ...
    NWStatisticDimension *_dmUrlLaunch;
    NWStatisticDimension *_dmSinceInitTime;
    NWStatisticDimension *_dmSinceLastLaunchTime;
    NWStatisticDimension *_dmIsN2E;
    NWStatisticDimension *_dmSpeedBucket;
...
@property(retain, nonatomic) NWStatisticDimension *dmSpeedBucket; // @synthesize dmSpeedBucket=_dmSpeedBucket;
@property(retain, nonatomic) NWStatisticDimension *dmIsN2E; // @synthesize dmIsN2E=_dmIsN2E;
...
@property(retain, nonatomic) NWStatisticDimension *dmUrlLaunch; // @synthesize dmUrlLaunch=_dmUrlLaunch;
