...
+ (id)readFileAtPath:(id)arg1 targetAudioDescription:(struct AudioStreamBasicDescription)arg2 readBlock:(CDUnknownBlockType)arg3 completionBlock:(CDUnknownBlockType)arg4 blockSize:(unsigned int)arg5;
+ (id)readFileAtPath:(id)arg1 targetAudioDescription:(struct AudioStreamBasicDescription)arg2 readBlock:(CDUnknownBlockType)arg3 completionBlock:(CDUnknownBlockType)arg4;
+ (id)loadFileAtPath:(id)arg1 targetAudioDescription:(struct AudioStreamBasicDescription)arg2 completionBlock:(CDUnknownBlockType)arg3;
+ (_Bool)infoForFileAtPath:(id)arg1 audioDescription:(struct AudioStreamBasicDescription *)arg2 length:(unsigned int *)arg3 error:(id *)arg4;
